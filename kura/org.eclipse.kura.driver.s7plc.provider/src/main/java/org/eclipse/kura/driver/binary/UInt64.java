...
class UInt64 extends AbstractBinaryData<BigInteger> {

    public UInt64(Endianness endianness) {
        super(endianness, 8);
    }

    @Override
    public void write(Buffer buf, int offset, BigInteger bigInteger) {
    ...
    @Override
    public BigInteger read(Buffer buf, int offset) {
        Long result;
        if (this.endianness == Endianness.BIG_ENDIAN) {
