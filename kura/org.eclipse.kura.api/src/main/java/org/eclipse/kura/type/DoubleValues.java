...
import static org.eclipse.kura.type.DataType.DOUBLES;
...
@ThreadSafe
@ProviderType
public class DoubleValues implements TypedValue<Double[]> {
     ...
     *                  the value
     */
    public DoubleValues(final Double[] value) {
        this.value = value;
    }
    ...
    public int compareTo(final TypedValue<Double[]> otherTypedValue) {
        ...
        final Double[] otherValue = otherTypedValue.getValue();
    ...
    public String toString() {
        return "DoubleValues [value=" + Arrays.toString(this.value) + "]";
    }
